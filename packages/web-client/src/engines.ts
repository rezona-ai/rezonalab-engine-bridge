...
const BASE: readonly Omit<EngineInfo, 'install'>[] = [
  { key: 'cocos', displayName: 'Cocos', portRange: [41700, 41719], supported: true, pluginVersion: '0.1.7', minPluginVersion: '0.1.0', installDocUrl: `${DOCS}/install-cocos.md` },
  { key: 'unity', displayName: 'Unity', portRange: [41720, 41739], supported: true, pluginVersion: '0.1.7', minPluginVersion: '0.1.0', installDocUrl: `${DOCS}/install-unity.md` },
  { key: 'godot', displayName: 'Godot', portRange: [41740, 41759], supported: false, pluginVersion: '0.1.7', minPluginVersion: '0.1.0', installDocUrl: `${DOCS}/install-godot.md` },
  { key: 'unreal', displayName: 'Unreal Engine', portRange: [41760, 41779], supported: false, pluginVersion: '0.1.7', minPluginVersion: '0.1.0', installDocUrl: `${DOCS}/install-unreal.md` },
  { key: 'blender', displayName: 'Blender', portRange: [41780, 41799], supported: false, pluginVersion: '0.1.7', minPluginVersion: '0.1.0', installDocUrl: `${DOCS}/install-blender.md` },
];
